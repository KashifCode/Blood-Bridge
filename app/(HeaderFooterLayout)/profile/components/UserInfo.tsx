      ...
      {isLoading ? (
        ...
        <>
          <div className="relative w-full bg-[#EEEBEB] flex flex-col justify-center items-center gap-y-4 py-4 rounded-[33px]">
            <span className="absolute left-3.5 top-3.5 bg-bloodBankNavRed rounded-lg p-1.5 font-RobotoBold text-white text-sm">
              {user?.bloodGroup}
            </span>
            <p className="capitalize text-black text-4xl font-LateefRegular">
              Profile
            </p>
            <div
