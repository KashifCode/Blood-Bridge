  ...
  return (
    <div className="flex flex-col justify-between w-full relative">
      ...
      <form onSubmit={handleSubmit} className="w-full flex flex-col items-end">
        <textarea
          className="w-full bg-slate-200 bg-opacity-90 rounded-[14px] focus:outline-0 p-3 text-black font-RobotoRegular placeholder:text-black placeholder:font-RobotoMedium"
        ...
        <Button
          type="submit"
          className="!w-max !rounded-3xl !bg-darkRed hover:!bg-red-800 !h-auto !py-2 min-w-[130px] !text-base mt-4"
        >
          Submit
        </Button>
      </form>
