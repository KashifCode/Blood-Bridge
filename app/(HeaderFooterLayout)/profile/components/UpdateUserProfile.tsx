...
const UpdateUserProfile = () => {
  ...
  return (
    <div className="flex flex-col justify-between w-full relative">
      ...
      {!isEdit && (
        <span
          className="absolute top-2 right-2 w-max rounded-3xl bg-darkRed hover:bg-red-800 px-5 py-0.5 text-white text-center cursor-pointer"
      ...
      <Accordion type="single" collapsible>
        <AccordionItem className="!border-none" value="showPassword">
          <AccordionTrigger className="text-black font-RobotoBold text-xl mb-4 hover:no-underline bg-white !py-1.5 mt-4 px-3 rounded-md">
            Password
          </AccordionTrigger>
          <AccordionContent>
            <UpdateUserPassword
