...
const UpdateUserForm = ({
  ...
  const schema: ZodType<UpdateUserData> = z.object({
    ...
    cnic: z
      ...
      .refine((value) => Constants.CNIC_REGEXP.test(value), {
    ...
    >
      <div className="flex flex-col">
        ...
        {changeDetails ? (
          <input
            {...register("firstName")}
            className="bg-white rounded-3xl w-full py-2 px-3.5 focus:outline-0"
            type="text"
          />
        ) : (
          <input
      ...
      <div className="flex flex-col">
        <label
          className="text-black font-RobotoMedium mb-0.5 ps-3 uppercase"
          htmlFor="cnic"
        >
          CNIC
        </label>
      ...
      {changeDetails && (
        <Button
          type="submit"
          className="!w-max !rounded-3xl !bg-darkRed hover:!bg-red-800 mt-1 !h-auto !py-2 min-w-[150px] !text-base"
        >
          Save Changes
        </Button>
      )}
