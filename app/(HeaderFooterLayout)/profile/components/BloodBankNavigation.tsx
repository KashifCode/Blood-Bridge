    ...
    >
      <Link href={"/profile/bloodBank/dashboard"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          />
          <Dashboard
            svgClass="w-[22px] h-[22px]"
            color={isBBDashboard ? "#BF372A" : "#1C1A19"}
          />
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBDashboard,
            })}
          >
            Dashboard
          </p>
      ...
      <Link href={"/profile/bloodBank/users"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBUsers,
            })}
          >
            Users
          </p>
      ...
      <Link href={"/profile/bloodBank/requests"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBOrders,
            })}
          >
            Requests
          </p>
      ...
      <Link href={"/profile/bloodBank/events"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBEvents,
            })}
          >
            Events
          </p>
      ...
      <Link href={"/profile/bloodBank/blood"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBBlood,
            })}
          >
            Blood
          </p>
      ...
      <Link href={"/profile/bloodBank/donation"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <Image
            ...
            src={isBBDonation ? bloodDonationIcon : bloodDonationBlackIcon}
            alt="Blood Donations"
          />
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBDonation,
            })}
          >
            Donation
          </p>
      ...
      <Link href={"/profile/bloodBank/types-blood"}>
        <div className="w-full relative flex items-center gap-x-1 py-2 ps-5">
          <div
            className={cx(
              "hidden absolute top-0 left-0 h-full border-l-[3px] border-bloodBankNavRed",
              { "!block": isBBTypesBlood },
            )}
          />
          <BloodTypeIcon
            svgClass="w-[28px] h-[28px]"
            color={isBBTypesBlood ? "#BF372A" : "#1C1A19"}
          />
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBTypesBlood,
            })}
          >
            Blood Types
          </p>
      ...
      <Link href={"/profile/bloodBank/settings/management"}>
        <div className="w-full relative flex items-center gap-x-2 py-2 ps-5">
          ...
          <Settings
            svgClass="w-[22px] h-[22px]"
            color={isBBSettings ? "#BF372A" : "#1C1A19"}
          />
          <p
            className={cx("text-[#1C1A19] font-DMSansBold capitalize", {
              "!text-bloodBankNavRed": isBBSettings,
            })}
          >
            Settings
          </p>
      ...
      <Link href={"/profile/bloodBank/request-users"}>
        <div className="w-full flex justify-center">
          <Button className="!h-auto !font-LatoMedium !text-white !bg-darkRed hover:!bg-red-800 !rounded-[48px] !text-xl !pb-1.5 !pt-1 !px-6 w-max mx-auto">
            Request
          </Button>
        </div>
      </Link>
