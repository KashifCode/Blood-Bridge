        ...
        >
          <div className="w-1/2 flex flex-col gap-y-1.5 mb-1">
            <div className="flex items-center gap-x-1.5">
              <Switch
                {...register("giveBlood")}
                checked={giveBlood}
                onCheckedChange={changeGiveBlood}
                id="giveBlood"
                className="data-[state=checked]:!bg-green-500"
              />
              <Label htmlFor="activeStatus">Give & Take Blood</Label>
            </div>
            <p className="text-xs font-LatoRegular text-slate-900 text-opacity-50">
              This is a one-time setting, if your blood bank gives blood on
              basis of exchange, kindly turn this switch on.
            </p>
          </div>
          <div className="w-1/2 flex flex-col gap-y-2.5">
            <div className="flex flex-col gap-y-1.5">
              ...
              <select
                className="bg-slate-100 rounded-[5px] w-full py-2 px-3.5 focus:outline-0"
                {...register("city")}
              >
          ...
          <Button
            type="submit"
            className="!w-max !rounded-3xl !bg-darkRed hover:!bg-red-800 mt-6 !h-auto !py-1.5 min-w-[110px] !text-sm"
          >
            Update
          </Button>
        </form>
