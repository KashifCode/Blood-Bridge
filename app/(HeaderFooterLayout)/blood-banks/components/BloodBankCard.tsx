      ...
      {bloodBanks.map((BB_Data, index) => (
        ...
        >
          <div className="w-full h-[91%] flex flex-col gap-y-1.5">
            ...
            <div className="flex flex-col gap-y-1 h-[55%]">
              ...
              <div className="flex gap-x-2">
                ...
                <p className="text-[15x] font-LatoRegular text-black">
                  {BB_Data?.bloodBank?.address}
                  <br />
                  Sector: {BB_Data?.bloodBank?.sector}
                </p>
              </div>
              ...
              <div className="grid grid-cols-4 gap-y-2 my-2 px-2">
                {BB_Data?.bloodGroups?.map((BG_Data: any, index: any) => (
                  ...
                  >
                    <p className="font-LatoBold text-black text-sm">
                      {BG_Data.bloodGroup}
                    </p>
                    <p className=" font-LatoRegular text-black text-sm">
                      {BG_Data.stock}
                    </p>
                  </div>
                ))}
          ...
          <div className="flex items-start gap-x-3 h-[8%]">
            <Link
              href={`/blood-banks/request-blood?id=${BB_Data?.bloodBank?._id}`}
            >
              <Button
                variant={"outline"}
            ...
            <Link
              href={`/blood-banks/donate-blood?id=${BB_Data?.bloodBank?._id}`}
            >
              <Button
                variant={"outline"}
                className="!py-0.5 !pr-0 !h-auto uppercase tracking-[5px] !rounded-full !border-2 !border-red-700 hover:!bg-red-700 hover:!text-white min-w-[100px] md:!min-w-[108px] lg:!min-w-[120px] font-DMSansMedium focus:!ring-0 text-xs md:!text-sm lg:!text-base !pl-1"
