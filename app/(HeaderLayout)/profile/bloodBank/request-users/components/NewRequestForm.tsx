    ...
    return (
        <form onSubmit={handleSubmit(submitData)} className='w-4/5 pl-6 flex flex-col gap-y-6 mb-6'>
            ...
            <div className='flex flex-col gap-y-1.5 mt-4'>
                <Label className='pl-2' htmlFor='area'>Area</Label>
                    ...
                    <SelectContent>
                        <SelectGroup>
                            ...
                            {islamabadSectors.map((sector, index) => (
                                <SelectItem key={index} value={sector}>{`Sector ${sector}`}</SelectItem>
                            ))}
                        </SelectGroup>
                    </SelectContent>
                </Select>
            ...
            {/* Blood Type */}
            <div className='flex flex-col gap-y-1.5'>
                <Label className='pl-2' htmlFor='bloodType'>Blood Type</Label>
            ...
            {/* No. of Blood Bags */}
            <div className='flex flex-col gap-y-1.5'>
                <Label className='pl-2' htmlFor='bloodBags'>Blood Bags</Label>
                <Select onValueChange={(val) => setBloodBags(Number(val))}>
                    ...
                    <SelectContent>
                        {bloodBagsQuantity.map((bloodBagQuantity, index) => (
                            <SelectItem key={index} value={bloodBagQuantity.toString()}>{`${bloodBagQuantity}`}</SelectItem>
                        ))}
                    </SelectContent>
                </Select>
            </div>
            ...
            <div className="flex items-center space-x-2">
                <Checkbox id="requiredUrgently" onCheckedChange={(checked) => setIsRequiredUrgently(checked ? true : false)} />
                <label
