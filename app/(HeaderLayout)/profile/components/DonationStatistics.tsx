...
const DonationStatistics = () => {
    ...
    return (
        <div className={cx('w-full bg-stone-50 pl-[2%] pr-[4%] pt-6 relative', { [shadow.bloodBankNavHeight]: !showModal }, {'overflow-hidden': showModal}, { [shadow.BBPanelScrollHeight]: showModal })}>
            <p className='font-DMSansSemiBold mb-4 text-xl text-slate-900 capitalize'>Blood Donation Statistics</p>
                ...
                <div className={`bg-white w-full py-4 px-2.5 mt-4 rounded-lg ${shadow.lightShadow}`}>
                    ...
                    <Table className='!rounded-lg overflow-hidden'>
                        ...
                        <TableBody className=''>
                            ...
                            {bloodDonations && bloodDonations.length > 0 ? bloodDonations.map((donation, index) => (
                                <TableRow key={index}>
