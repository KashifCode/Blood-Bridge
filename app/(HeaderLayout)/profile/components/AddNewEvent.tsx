...
const AddNewEvent = () => {
    ...
    return (
        <div className='w-full px-[5%]'>
            ...
            <Form {...form}>
                <form onSubmit={form.handleSubmit(handleNewEvent)} className="space-y-4">
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className='bg-[#E9DFDF]' placeholder="Event Name" {...field} />
                                </FormControl>
                                {/* <FormMessage /> */}
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea rows={3} style={{ resize: 'none' }} className={`bg-[#E9DFDF]`} placeholder="Event Description" {...field} />
                                </FormControl>
                                {/* <FormMessage /> */}
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className='bg-[#E9DFDF]' placeholder="Venue" {...field} />
                                </FormControl>
                                {/* <FormMessage /> */}
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input type='time' className='bg-[#E9DFDF]' placeholder="Time" accept='image/*' {...field} />
                                </FormControl>
                                {/* <FormMessage /> */}
                            </FormItem>
                        )}
                    ...
                    <div>
                        ...
                        />
                        {image &&
                            <p className='text-sm text-black mt-2'><strong>Selected File:</strong> {image?.[0]?.name}</p>
                        }
                    </div>
