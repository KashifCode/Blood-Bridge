        ...
        <li>
          <Link
            className={cx(
              ...
              { "bg-red-700  !text-white": isActive("/") && isMbl },
              {
                "inline-block min-w-[180px] sm:!min-w-[240px] !text-center rounded-sm py-1":
                  isMbl,
              },
              { "hover:text-red-700": !isActive("/") && isMbl },
            )}
            href="/"
          >
            Home
        ...
        <li>
          <Link
            className={cx(
              ...
              { "!bg-red-700 !text-white": isActive("/event") && isMbl },
              {
                "inline-block min-w-[180px] sm:!min-w-[240px] !text-center rounded-sm py-1":
                  isMbl,
              },
              { "hover:text-red-700": !isActive("/event") && isMbl },
            )}
            href="/event"
          >
            Event
