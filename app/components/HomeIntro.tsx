...
const HomeIntro = ({ isSecondImage }: { isSecondImage?: boolean }) => {
  return (
    <div className={cx('w-full flex items-end flex-col-reverse md:!flex-row pl-[6%] pr-[3%] mt-12 gap-x-4 2xl:!pr-[6%] 2xl:!justify-between', { 'mb-6 md:!mb-1 !items-center !gap-x-8': isSecondImage })}>
      <div className={cx('w-full md:!w-2/5 flex flex-col gap-y-3.5 mt-5 md:!mt-0 2xl:!w-[45%]', { 'md:!w-2/6 2xl:!w-2/6': isSecondImage })}>
      ...
      {isSecondImage &&
        ...
        <div className='w-[45%]'>
          <Image className='w-full object-cover' src={homeIntro2} alt='Home Intro' />
        </div>
      </div>
      }
      {isSecondImage &&
