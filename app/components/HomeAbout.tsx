        ...
        <div className='w-full pl-[6%] pr-[3%] pt-[2%] pb-[4%] lg:!pb-[3%]'>
            <div className='w-full px-4 sm:px-10 !md:pr-0 pt-6 sm:pt-8 pb-10 bg-neutral-100 flex gap-x-6 flex-col md:!flex-row'>
                ...
                <div className='w-full md:!w-2/5 mt-5 md:!mt-0 relative'>
                    <Image className="ms-auto w-[85%] object-contain max-h-[31vh] sm:!max-h-[36vh] md:!max-h-[45vh] xl:!max-h-[40vh] 2xl:!max-h-[36vh]" src={homeAboutLower} alt="About Visual 1" />
                    <Image className="absolute top-7 left-0 w-[85%] object-contain max-h-[28vh] sm:!max-h-[33vh] md:!max-h-[42vh] xl:!max-h-[37vh] 2xl:!max-h-[33vh]" src={homeAboutUpper} alt="About Visual 2" />
                </div>
            </div>
        </div>
    )
